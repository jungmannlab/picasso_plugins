...
## For developers
To create a plugin, you can use the template provided in [picasso/plugin_template.py](https://github.com/jungmannlab/picasso/blob/master/plugin_template.py).
